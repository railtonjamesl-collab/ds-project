...
ggplot(data = melted_corr_mat, aes(x=Var1, y=Var2,fill=value)) + labs(title = "Correlation Heatmap of PaySim Variables", fill = "Correlation") + geom_tile() + theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 10), axis.text.y = element_text(size = 10)) +geom_text(aes(Var2, Var1, label = value),color = "black", size = 4)
```
