...
Trends all of the histograms for numerical data show that most of the people applying for a loan tend to be:
...
These bar charts show a pretty even spread between all catagprical data.
...
Here we can see that there are several varaibles that are strongly correlated. These are person age, the number of years of employment experience that they have and the umber of years of credit history they have. This is to be expected as age limits how both of these other variables. Also note that a persons income is ever so slightly negatively correlated with the loan percentage amount. 
...
This has not added too many NAs to the data so I do not think they need removing.
